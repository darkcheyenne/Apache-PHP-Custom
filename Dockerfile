...
#####################################
RUN apt-get update && apt-get install -y curl php7.2-common php7.2-curl unzip s3cmd php7.2-gd php-xml php-xml  memcached php-memcached nasm apache2 libapache2-mod-php7.2 php-fpm php7.2-mbstring php7.2-mysql wget && rm -rf /var/lib/apt/lists/* && rm -R /var/www/html/*
