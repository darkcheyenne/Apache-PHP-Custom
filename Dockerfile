...
#####################################
RUN apt-get update && apt-get install -y software-properties-common && add-apt-repository ppa:ondrej/apache2 && apt-get update && apt-get install -y php-curl zip unzip php7.2-zip curl php7.2-common s3cmd php7.2-gd php-xml php-xml brotli memcached php-memcached nasm apache2 libapache2-mod-php7.2 php-fpm php7.2-mbstring php7.2-mysql wget && rm -rf /var/lib/apt/lists/* && rm -R /var/www/html/*
